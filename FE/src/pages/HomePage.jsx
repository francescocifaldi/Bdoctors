      ...
      <div className="container-fluid container">
        <Row className="mb-3">
          <Form className="d-flex gap-5 filterBar" onSubmit={handleSearch}>
            ...
            <Button className="w-50 btn btn-primary SearchBtn" type="submit" variant="primary">
              Invia
            </Button>
          </Form>
        </Row>
        ...
        <div className="d-flex flex-column-reverse flex-md-row justify-content-between align-items-center my-5">
          <div className="text-light doctorCaption" style={{ color: "#0f3439" }}>
            <h3>Sei un Medico?</h3>
            <h5 className="fs-4">Iscriviti e raggiungi nuovi pazienti.</h5>
            <p className="fs-4">
              Più di 1 milione di pazienti <br /> cercano ogni mese il loro Medico su BDoctors <br /> il primo sito in
              Italia per visitatori.
            </p>
            <p className="fs-4">
              Unisciti alla nostra comunità di medici e raggiungi un pubblico vasto e interessato. Con BDoctors, puoi:
            </p>
            <ul>
              <li>Creare un profilo professionale e personalizzato</li>
              <li>Presentare le tue competenze e i tuoi servizi</li>
              <li>Aumentare la tua visibilità online e raggiungere nuovi pazienti</li>
            </ul>
            <p className="fs-4">
              Non perdere l'opportunità di crescere la tua attività e di aiutare più persone. Iscriviti ora e scopri come
              BDoctors può aiutarti a raggiungere i tuoi obiettivi.
            </p>
            <h5>Vantaggi di iscriversi a BDoctors:</h5>
            <ul>
              <li>Aumento della visibilità online</li>
              <li>Maggiore accesso a nuovi pazienti</li>
              <li>Possibilità di creare un profilo professionale personalizzato</li>
              <li>Opportunità di essere trovato da pazienti che cercano un medico specializzato come te</li>
            </ul>
          </div>
          <div className="d-none d-md-block">
            <img src="./doctorCaption.png" alt="Doctor Caption" className="img-fluid" />
          </div>
        </div>
